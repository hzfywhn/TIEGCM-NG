subroutine comp_n2d_ng(n2d,i_ng)
  ...
  real,dimension(nlevp1_ng(i_ng),flds(i_ng)%lond0:flds(i_ng)%lond1,flds(i_ng)%latd0:flds(i_ng)%latd1) :: &
    o2,o1,no,ne,op,n2p,nop,xnmbarm,rk3,ra1,ra3,beta5,qtef,n2d_prod,n2d_loss,qtefi,nei
  ...
  n2d_prod = qtefi*brn2d+rk3*n2p*xnmbarm*o1*rmassinv_o1+(ra1*nop*0.85+ra3*n2p*0.9)*nei
  n2d_loss = xnmbarm*(beta2*o2*rmassinv_o2+beta4*o1*rmassinv_o1+beta6*no*rmassinv_no)+beta7+beta5*nei+rk10*op
  n2d = rmass_n2d*n2d_prod/(n2d_loss*xnmbarm)
